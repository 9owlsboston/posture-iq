"""SecPostureIQ Tool — generate_remediation_plan
...
def _generate_mock_response() -> dict[str, Any]:
    ...
    steps = [
        {
            ...
            "script": (
                ...
                "$params = @{\n"
                '    DisplayName = "SecPostureIQ: Block Legacy Authentication"\n'
                "    State = 'enabled'\n"
                "    Conditions = @{\n"
        ...
        },
        {
            ...
            "script": (
                ...
                "Connect-MgGraph -Scopes 'Policy.ReadWrite.ConditionalAccess'\n\n"
                "$params = @{\n"
                '    DisplayName = "SecPostureIQ: Sign-in Risk — Require MFA"\n'
                "    State = 'enabled'\n"
                "    Conditions = @{\n"
        ...
        },
        {
            ...
            "script": (
                ...
                "New-SafeAttachmentPolicy -Name 'SecPostureIQ: Safe Attachments' `\n"
                "    -Enable $true `\n"
        ...
        },
        {
            ...
            "script": (
                ...
                "Connect-MgGraph -Scopes 'Policy.ReadWrite.ConditionalAccess'\n\n"
                "$params = @{\n"
                '    DisplayName = "SecPostureIQ: Require MFA for All Users"\n'
    ...
    return {
        ...
        "steps": steps,
        "disclaimer": (
            "⚠️ Generated by SecPostureIQ (AI-assisted) — review with your security team "
