"""SecPostureIQ Tool — create_adoption_scorecard
...
def _generate_mock_response() -> dict[str, Any]:
    ...
    return {
        ...
        "disclaimer": (
            "⚠️ Generated by SecPostureIQ (AI-assisted) — review with your security "
...
def _generate_markdown_scorecard(
    ...
    lines = [
        "# SecPostureIQ — ME5 Adoption Scorecard",
        "",
    ...
    lines.extend(
        [
            ...
            "---",
            "",
            "*⚠️ Generated by SecPostureIQ (AI-assisted) — review with your security team before implementing.*",
        ]
    )
