...
DISCLAIMER_TEXT = (
    "⚠️ Generated by PostureIQ (AI-assisted) — review with your "
    "security team before implementing."
)
...
def has_disclaimer(output: dict[str, Any]) -> bool:
    ...
    return (
        ...
        and "Generated by" in disclaimer
        and "review with your security team" in disclaimer
    )
