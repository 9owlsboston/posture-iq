...
#   5. InformationProtectionPolicy.Read    — purview_policies (sensitivity labels)
...
add_permission "InformationProtectionPolicy.Read"     "4ad84827-5578-4e18-ad7a-86530b12f884" || true
